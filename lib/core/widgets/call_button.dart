import 'package:lansonndehplumbing/core/widgets/trigger_phone_call.dart';
...
class CallButton extends StatelessWidget {
  ...
  const CallButton(
      ...
      this.onPressed,
      this.message =
          "I am writing about your recent Order on Lanson Ndeh's Plumbing App. I would love to ...",
      required this.color})
      : super(key: key);
